@php
    ...
    // Get array of current role permission IDs
...
<x-app-layout>
    ...
    <x-dynamic-heading title="Edit Role: {{ $role->name }}" />
    ...
    <div class="">
        <div class="mx-auto">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                <!-- Form Start -->
                <form action="{{ route('roles.update', $role->id) }}" method="POST" x-data="permissionsForm({{ json_encode($rolePermissionIds) }})">
                    @csrf
                    @method('PUT')
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <div class="mt-2 text-sm text-blue-700">
                                                <p>Update the permissions for this role. You can use the "Check All" or "Uncheck All" buttons for quick selection.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        function permissionsForm(existingPermissions = []) {
            return {
