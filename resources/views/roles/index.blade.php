        ...
        <div class="mx-auto">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                <div class="space-y-4 pb-8">
                    <!-- Search Form and Add Role Button -->
                ...
                <div x-data="{ showModal: false, deleteId: null }">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                                <tr>
                                    ...
                                    <th
                                        class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-4/12">
                                        Permissions
                                    </th>
                                    <th
                                        class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-2/12">
                                    ...
                                    <th
                                        class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-3/12">
                                        Actions
                                    </th>
                                </tr>
                            </thead>
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex space-x-2">
                                                    ...
                                                    @can('delete roles')
                                                        <form
                                                            @submit.prevent="showModal = true; deleteId = {{ $role->id }}"
                                                            class="inline"
                                                            data-loading="false"
                                                            data-modal="true">
                                                            @csrf
                    ...
                    <!-- Code for Delete -->
                    <x-delete-modal title="Delete Role"
