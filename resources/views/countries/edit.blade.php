            ...
            <div class="lg:col-span-4">
                ...
                <div class="bg-white shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6">
                        ...
                        <p class="text-sm text-gray-600 mb-4">Follow these conventions for country data</p>
                        <div class="space-y-3">
                            <div class="p-3 bg-gray-50 rounded-lg">
                                <p class="text-xs font-semibold text-gray-700 mb-1">Country Name:</p>
                                <p class="text-xs text-gray-600">Use official country names (e.g., United States, United Kingdom)</p>
                            </div>
                            <div class="p-3 bg-gray-50 rounded-lg">
                            ...
                            <div class="p-3 bg-gray-50 rounded-lg">
                                ...
                                <p class="text-xs text-gray-600">Country codes should be uppercase, 2 characters</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-[#52A758] to-[#458F4A] shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <p class="text-sm text-white/90 mb-4">
                            Countries are used throughout the system for location data
                        </p>
